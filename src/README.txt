...
DecTree
      DecTree is a machine learning program that implements decision tree
      algorithm in order to learn boolean data sets. It supports csv file
      parse and tree post pruning.
